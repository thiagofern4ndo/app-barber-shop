    ...
    return Scaffold(
      body: SafeArea(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment
                  .spaceBetween, // Disposição dos ícones à esquerda e à direita
              children: [
          ...
          const SizedBox(
              height:
                  20), // Espaçamento entre a barra superior e o conteúdo abaixo
          ...
          CustomButton(
            ...
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const LoginPage()) //[ALTERAÇÃO] adicionado 'const' para otimização
                  );
            },
